...
## Validating addons
You can test to see if the `addons` folder is correct using [addons()]. You can also see if a particular addon module was installed correctly using the same function using, for example, `addons("addon.name")`.
