...
#'
#' @description `removeSession()` deletes a **GRASS** "session"s" [location and mapsets][tutorial_sessions] and all rasters and vectors therein. This function should be used cautiously, and is mainly provided as a way to clean up after running examples.
#'
