...
#'
#' @param x A `GRaster`, `GRegion`, or missing. If missing, the resolution of the currently active "region" is returned (see `vignette("11_regions", package = "fasterRaster")`).
#'
