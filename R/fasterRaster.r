...
#' \pkg{fasterRaster} makes heavy use of the \pkg{rgrass} package by Roger Bivand and others, the \pkg{terra} package by Robert Hijmans, and \pkg{sf} package by Edzer Pebesma and others, so is heavily indebted to their creators. \cr
#'
