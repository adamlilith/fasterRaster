...
#'
#' @description These functions either change the extent, dimensions, and/or resolution of a **GRASS** "region" or report the current region's extent, dimensions, and/or resolution (see `vignette("11_regions", package = "fasterRaster")`). These functions are mostly used internally and rarely of interest to most users.
