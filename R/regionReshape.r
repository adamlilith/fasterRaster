...
#'
#' @seealso [regionExt()], [regionDim()], and [regionRes()] in **fasterRaster**; [terra::ext()], [terra::dim()], and [terra::res()]; [sf::st_bbox()]; **GRASS** module [https://grass.osgeo.org/grass82/manuals/g.region.html](g.region)
#'
