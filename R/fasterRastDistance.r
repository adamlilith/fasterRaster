...
#'
#' @details See the documentation for the \code{GRASS} module \code{r.grow.distance}{https://grass.osgeo.org/grass82/manuals/r.grow.distance.html}.
#' @seealso \code{\link[terra]{distance}}, \code{\link[fasterRaster]{fasterVectToRastDistance}}
#'
#' @examples man/examples/ex_fasterRastDistance.r
#'
#' @export
