...
methods::setMethod(
	...
	for (i in seq_along(directions)) {
		...
		this <- makeGRaster(paste0(gn, '_', niceDirection), paste0('horizonHeight_', niceDirection, 'deg'))
