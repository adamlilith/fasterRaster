...
#' @param cores Positive numeric in the range [1, 1000]. Number of processor cores to use. Default is 1.
...
#' data(madElev)
#' 
#' # convert 0 elevation to NA (ocean)
...
#' 
#' # terrain rasters
#' fasterTerrain('madElev', slope=TRUE, aspect=TRUE, northIs0=FALSE,
...
fasterHorizon <- function(
	...
	horizon_basename = 'horizonHeight',
	horizon_step = 90,
