...
#' 
#' @description Get the coordinate reference system (CRS) of a `GLocation` object, or any that contain it (especially `GRaster`s and `GVector`s), or from the currently active **GRASS** "project/location" (see `vignette("10_projects_locations_mapsets", package = "fasterRaster")`).
#'
