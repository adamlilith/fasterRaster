...
**fasterRaster** makes heavy use of the **rgrass** package by Roger Bivand and others, the **terra** package by Robert Hijmans, and **sf** package by Edzer Pebesma and others, so is heavily indebted to their creators, in addition to the **GRASS** team at OS Geo.
