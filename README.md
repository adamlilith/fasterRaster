...
**fasterRaster** makes heavy use of the **rgrass** package by Roger Bivand and others, the **terra** package by Robert Hijmans, the **sf** package by Edzer Pebesma and others, and of course **GRASS GIS**, so is heavily indebted to all of these creators
