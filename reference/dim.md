...
- `nlyr()`: Layers (number of "stacked" rasters–different from depths of
  a raster).
...
- x:
  ...
  A `GRegion`, `GRaster`, `GVector`, or missing. If missing, then the
  dimensions of the currently active "region" are returned (see
