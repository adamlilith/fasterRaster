...
`GRaster`s and `GVector`s can have 2-dimensional or 3-dimensional
coordinates. This function returns the dimensions of the object.
...
- x:
  ...
  A `GSpatial` object (i.e., a `GRaster` or `GVector`).
