...
Raster of land cover for an eastern portion of Madagascar. Note that the
land cover classes have been simplified, so this raster should *not* be
used for "real" analyses.
