...
This function is a simple way to get example rasters or spatial vector
datasets that come with **fasterRaster**.
...
- x:
  ...
  The name of the raster or spatial vector to get. All of these
  represent a portion of the eastern coast of Madagascar.
  ...
  - [madCoverCats](https://github.com/adamlilith/fasterRaster/reference/madCoverCats.md):
    Land cover values and categories for `madCover`

  - [vegIndices](https://github.com/adamlilith/fasterRaster/reference/vegIndices.md):
    Vegetation indices that can be calculated with
