...
This data frame corresponds to the
[madCover](https://github.com/adamlilith/fasterRaster/reference/madCover.md)
raster, which represents land cover for an eastern portion of
Madagascar. Note that the land cover classes have been simplified, so
this table and raster should *not* be used for "real" analyses.
...
Arino O., P. Bicheron, F. Achard, J. Latham, R. Witt and J.-L. Weber.
2008. GlobCover: The most detailed portrait of Earth. European Space
Agency Bulletin 136:25-31. <http://due.esrin.esa.int>.
