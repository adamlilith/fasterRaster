...
- keepnums:
  ...
  Logical: If no `rownames` are present, create them. Default is `TRUE`.
...
[`terra::head()`](https://rspatial.github.io/terra/reference/headtail.html),
[`terra::tail()`](https://rspatial.github.io/terra/reference/headtail.html)
