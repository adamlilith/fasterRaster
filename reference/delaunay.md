...
This function creates a Delaunay triangulation from a "points"
`GVector`.
...
[`terra::delaunay()`](https://rspatial.github.io/terra/reference/voronoi.html),
tool `v.delaunay` in **GRASS**
